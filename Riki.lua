...
rikiMartini.optionEnableScript = Menu.AddOption({"Hero Specific", "Riki"}, "1.Enable", "Turn on/off this script.")
rikiMartini.PressComboKey = Menu.AddKeyOption({ "Hero Specific","Riki" }, "2. Execute combo key", Enum.ButtonCode.KEY_I)
rikiMartini.enablePhaseBootAuto = Menu.AddOption({ "Hero Specific","Riki" }, "3. Auto usage phase boots.", "")
